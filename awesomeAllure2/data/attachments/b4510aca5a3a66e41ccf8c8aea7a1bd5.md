...
- Name: ts >> "Playwright"
- Location: /home/runner/work/allure3-demo/allure3-demo/test/e2e/start.test.ts:56:5
...
============================================================
    ...
    at /home/runner/work/allure3-demo/allure3-demo/test/e2e/start.test.ts:67:7
```
...
- banner:
  ...
  - link "Star allure-framework/allure2 on GitHub":
    - /url: https://github.com/allure-framework/allure2
    - text: Star
  - link "4623 stargazers on GitHub":
...
- list:
  - listitem:
    - radio "Package manager npm yarn pnpm"
    - img
    - text: npm
  - listitem:
    - radio "yarn"
