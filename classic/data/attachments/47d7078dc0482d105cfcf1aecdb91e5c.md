...
Call log:
  - waiting for getByText('Download .zip')
    - locator resolved to <button type="submit" class="button color-border/border primary">Download .zip</button>
  - attempting click action
    - waiting for element to be visible, enabled and stable

    at StartPage.checkTestDataSets (/home/runner/work/allure3-demo/allure3-demo/test/e2e/pageObjects/start.ts:128:52)
