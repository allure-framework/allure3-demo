...
============================================================
    ...
    at /home/runner/work/allure3-demo/allure3-demo/test/e2e/start.test.ts:113:7
```
...
- textbox "Vendor name*": examples.allure
- paragraph: Project name*
- textbox "Project name*": phpunit-example
- paragraph: Root namespace*
- textbox "Root namespace*": Examples\Allure\PHPUnitExample
- paragraph: Minimal PHP version
- list:
  - listitem:
    - radio "Minimal PHP version php8.1 php8.2 php8.3"
    - text: php8.1
  - listitem:
    - radio "php8.2"
    - text: php8.2
  - listitem:
    - radio "php8.3" [checked]
    - text: php8.3
- text: "4"
