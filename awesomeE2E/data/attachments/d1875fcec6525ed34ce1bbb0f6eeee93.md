...
- Name: kotlin >> "JUnit5"
- Location: /home/runner/work/allure3-demo/allure3-demo/test/e2e/start.test.ts:80:5
...
Call log:
  - waiting for getByText('11', { exact: true })
    - locator resolved to <span class="truncate pointer-events-none">11</span>
  - attempting click action
    - scrolling into view if needed
    - done scrolling

    at StartPage.checkTestDataSets (/home/runner/work/allure3-demo/allure3-demo/test/e2e/pageObjects/start.ts:120:69)
    at /home/runner/work/allure3-demo/allure3-demo/test/e2e/start.test.ts:92:7
```
...
- list:
  - listitem:
    - radio "Build tool Maven Gradle Gradle (Kotlin)"
    - img
    - text: Maven
  - listitem:
    - radio "Gradle" [checked]
    - img
    - text: Gradle
  - listitem:
    - radio "Gradle (Kotlin)"
...
```ts
   20 | export type DataSet = (SelectOptionDescriptor | InlinePickerOptionDescriptor)[];
   21 |
   22 | const cartesianMap = <T>(arrays: T[][]): T[][] => {
   23 |   const result: T[][] = [];
   24 |   const normalizedArrays = arrays.filter((array) => array.length > 0);
   25 |
